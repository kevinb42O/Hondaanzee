...
const HOTSPOT_ENTRIES: Omit<Hotspot, 'slug'>[] = [
  ...
  // Blankenberge - New Additions
  {
    ...
    image: '/grandcafecover.webp',
    images: ['/grandcafecover.webp', '/grandcafe1.webp', '/grandcafe2.webp', '/grandcafe.webp'],
    city: 'blankenberge',
  ...
  },
  {
    ...
    description: 'Na een dagje uitwaaien op het strand of slenteren rond de haven van Blankenberge, schuif je bij Restaurant Koekie\'s zó aan. Het is hét adres voor wie houdt van gezellig, laagdrempelig en vooral héél lekker eten.\n\nGeen gedoe, maar wel de allerbeste ribbetjes en huisgemaakte garnaalkroketten van de kust. Een warme sfeer, een vertrouwde kaart en een plek waar je – na een uitstap met je trouwe viervoeter – gewoon ongedwongen kunt genieten. Echt zo’n vaste waarde waar je altijd met een glimlach naar terugkeert!',
