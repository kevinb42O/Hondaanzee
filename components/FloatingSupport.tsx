    ...
    if (isMinimized) {
        return (
            <button
                ...
                className="md:hidden fixed bottom-6 right-4 z-50 w-12 h-12 bg-amber-500 rounded-full shadow-2xl flex items-center justify-center text-white active:scale-90 transition-all duration-300 safe-area-bottom safe-area-right overflow-hidden relative"
            ...
            >
                ...
                <Bone size={20} className="fill-white relative z-10" />
            </button>
        );
    }
    ...
    return (
        <div className="md:hidden fixed bottom-6 right-4 z-50 safe-area-bottom safe-area-right">
            ...
            >
                ...
                <Bone size={18} className={`fill-white transition-transform relative z-10 ${!prefersReducedMotion ? 'group-hover:rotate-12' : ''}`} />
                <span className="font-black text-sm whitespace-nowrap relative z-10">Steun ons</span>
            </Link>
            <button
