      ...
      <div className="max-w-6xl mx-auto bg-slate-900 rounded-[2rem] sm:rounded-[2.5rem] md:rounded-[3.5rem] p-6 sm:p-8 md:p-20 relative overflow-hidden text-white shadow-2xl shadow-slate-300">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-16 items-center">
          <div>
            ...
            <button className="btn-lift w-full sm:w-auto bg-white text-slate-900 px-6 sm:px-8 py-3.5 sm:py-4 rounded-2xl font-black text-base sm:text-lg hover:bg-sky-50 active:bg-sky-100 shadow-xl flex items-center justify-center gap-3 touch-target">
              <Megaphone size={18} className="text-sky-600 sm:w-5 sm:h-5" />
              Gratis aanmelden
            </button>
          </div>
